	...
	<table>
		...
		<c:forEach var="cart" items="${cartLists }">
			<tr>
				...
				<td width="100">
					<fmt:formatNumber value="${cart.getBuy_price() }" type="number"
					pattern="#,##0"></fmt:formatNumber>원</td>
				<td width="150">
				...
				<td align="center" width="150">
					...
					<fmt:formatNumber value="${amount }" type="number" pattern="#,##0"></fmt:formatNumber>원
			...
			<tr>
				<td colspan="4" align="right" class="b">총 금액 :
					<fmt:formatNumber value="${total }" type="number" pattern="#,##0"></fmt:formatNumber>원</td>
			</tr>
			<tr height="10">
